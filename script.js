...
function saveState() {
  if (!initialized) return;
  localStorage.setItem('visorStateV3:Visor_Cuajimalpa_de_Morelos', JSON.stringify({
...
function restoreState() {
  let state = {};
  try { state = JSON.parse(localStorage.getItem('visorStateV3:Visor_Cuajimalpa_de_Morelos') || '{}'); } catch {}
